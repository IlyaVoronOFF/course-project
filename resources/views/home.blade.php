...
@section('content')
        ...
        <div class="swiper-container main-slider-2 swiper-arrow with-bg_white">
            <div class="swiper-wrapper">
                <div class="swiper-slide animation-style-02 slide-style-2">
                    <div class="slide-inner bg-height py-6 py-lg-0" data-bg-image="assets/images/slider/bg/2-1.jpg">
                        <div class="container">
                            <div class="row">
                                    ...
                                    <div class="inner-img">
                                        <div class="scene fill">
                                            <div class="expand-width" data-depth="0.2">
                                                <img src="assets/images/slider/inner-img/2-1-654x444.png" alt="Inner Image">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6 col-md-8 offset-md-2 offset-lg-0 order-1 order-lg-2">
                                    <div class="inner-img">
                                        <div class="scene fill">
                                            <div class="expand-width" data-depth="0.2">
                                                <img src="assets/images/slider/inner-img/2-2-654x444.png" alt="Inner Image">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                ...
                <div class="product-custom-col col-12">
                    <div class="product-category-item">
                        <a class="product-category-img img-zoom-effect" href="shop.html">
                            <img src="assets/images/product/top-category/1-1-180x180.png" alt="Top Category">
                        </a>
    ...
    <div class="product-area section-space-top-100">
        <div class="container">
            <div class="section-title style-2 pb-55">
                <h2 class="title mb-0">Выгодные предложения</h2>
            </div>
            <div class="row">
                <div class="col-lg-3">
    ...
    <div class="product-area section-space-y-axis-100">
        <div class="container">
            <div class="section-title style-2 pb-55">
                <h2 class="title mb-0">Новые товары</h2>
            </div>
            <div class="row">
                <div class="col-lg-6">
