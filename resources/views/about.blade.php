...
@section('content')
        ...
        <main class="main-content">
                            ...
                            <div class="about-banner-img row">
                                <div class="col-lg-4">
                                    <div class="single-img img-hover-effect">
                                        <img class="img-full" src="assets/images/about/banner/1-1-400x500.jpg" alt="About Banner">
                                    </div>
                                </div>
                                <div class="col-lg-4 section-space-top-100">
                                    <div class="single-img img-hover-effect">
                                        <img class="img-full" src="assets/images/about/banner/1-2-400x500.jpg" alt="About Banner">
                                    </div>
                                </div>
                                <div class="col-lg-4 section-space-top-100 pt-lg-0">
                                    <div class="single-img img-hover-effect">
                                        <img class="img-full" src="assets/images/about/banner/1-3-400x500.jpg" alt="About Banner">
                                    </div>
                                </div>
                            </div>
                        </div>
                                        ...
                                        <div class="user-info mb-3">
                                            <div class="user-shape-wrap">
                                                <div class="user-shape">
                                                    <img src="assets/images/testimonial/user/shape/1.png" alt="User Image">
                                                </div>
                                                <div class="user-img">
                                ...
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide">
                                        <div class="team-member-item img-gradient-effect">
                                            <div class="team-member-img">
                                                <a href="#">
                                                    <img class="img-full" src="assets/images/about/team/1-1-400x442.jpg" alt="Team Member">
                                                </a>
                                            </div>
                                    ...
                                    <div class="swiper-slide">
                                        <div class="team-member-item img-gradient-effect">
                                            <div class="team-member-img">
                                                <a href="#">
                                                    <img class="img-full" src="assets/images/about/team/1-2-400x442.jpg" alt="Team Member">
                                                </a>
                                            </div>
                                            <div class="team-member-content">
                                                <h2 class="title mb-0">Jaren Hammer</h2>
                                    ...
                                    <div class="swiper-slide">
                                        <div class="team-member-item img-gradient-effect">
                                            <div class="team-member-img">
                                                <a href="#">
                                                    <img class="img-full" src="assets/images/about/team/1-3-400x442.jpg" alt="Team Member">
                                                </a>
                                            </div>
                                            <div class="team-member-content">
                                                <h2 class="title mb-0">Jaren Hammer</h2>
            ...
            <!-- Begin Banner Area -->
            <div class="banner-area banner-style-2 section-border-y-axis section-space-y-axis-100" data-bg-image="assets/images/background-img/1-3-1920x208.png">
                <div class="container">
                    <div class="row">
                        <div class="col-lg-12">
