                    ...
                    <div class="modal-body">
                        <div class="modal-search">
                            ...
                            <form action="#" class="hm-searchbox">
                                <input type="text" name="Search entire store here..." value="Поиск по всему магазину..." onblur="if(this.value==''){this.value='Поиск по всему магазину...'}" onfocus="if(this.value=='Поиск по всему магазину...'){this.value=''}">
