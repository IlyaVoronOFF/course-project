...
<head>
  ...
  <!-- Bootstrap Css -->
  <link href="assets/css/admin/bootstrap.min.css" id="bootstrap-style" rel="stylesheet" type="text/css" />
  <!-- Icons Css -->
  <link href="assets/css/admin/icons.min.css" rel="stylesheet" type="text/css" />
  <!-- App Css-->
  <link href="assets/css/admin/app.min.css" id="app-style" rel="stylesheet" type="text/css" />
        ...
        <div class="d-flex">
          ...
          <div class="navbar-brand-box">
            <a href="index.html" class="logo logo-light">
              <span class="logo-sm">
                <img src="assets/images/admin/logo-sm.png" alt="" height="22">
              </span>
              <span class="logo-lg">
                <img src="assets/images/admin/logo-light.png" alt="" height="18">
              </span>
            </a>
          </div>
